...
<body>
	...
	<table border="1 px" width="25%">
		...
		<tbody>
			<c:forEach var="employeeMap" items="${requestScope.employees}">
				<tr>
					<td>
<a href="/java-web-examples/EditEmployeeServlet?action=edit&id=<c:out value="${employeeMap['ID']}" /> ">
							<img src="/java-web-examples/images/edit_icon.png"
							alt="no image found" height="20" width="20">
					</a>
					
<a href="/java-web-examples/AddOrEditEmployee?action=delete&id=<c:out value="${employeeMap['ID']}" /> ">
							<img src="/java-web-examples/images/delete_icon.png"
							alt="no image found" height="20" width="20">
					</a>
					
					</td>
					<td><c:out value="${employeeMap['FIRST_NAME']}" /></td>
					<td><c:out value="${employeeMap['LAST_NAME']}" /></td>
